    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-wrap gap-1 mt-2">
              {CATEGORIES.map((c) => (
                <button
                  key={c}
                  type="button"
                  onClick={() => setForm({ ...form, category: form.category ? `${form.category}, ${c}` : c })}
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Budget / Investment Amount ($)</label>
            <input
              type="number"
              value={form.budget}
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-green-400 text-white py-3 rounded-lg font-semibold hover:bg-green-500 disabled:opacity-50"
        >
