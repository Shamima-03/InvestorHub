...
function Actions({ match, busy, onAccept, onReject, onChat }) {
...
function GridCard({ match, other, otherRole, busy, onAccept, onReject, onChat }) {
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-5 hover:border-emerald-200 hover:shadow-sm transition-all flex flex-col">
      ...
      <div className="mt-4 pt-3 border-t border-gray-100">
        <Actions match={match} busy={busy} onAccept={onAccept} onReject={onReject} onChat={onChat} />
      </div>
    </div>
  );
}

function ListRow({ match, other, otherRole, busy, onAccept, onReject, onChat }) {
  return (
